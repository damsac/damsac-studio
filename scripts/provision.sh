...
echo ""
echo "Next steps:"
echo "  1. Create the dashboard password on the VPS:"
echo "     damsac-ssh 'mkdir -p /run/secrets && echo \"your-password\" > /run/secrets/damsac-dashboard-pw && chmod 600 /run/secrets/damsac-dashboard-pw'"
echo ""
echo "  2. Point DNS to $SERVER_IP (optional, for TLS)"
echo ""
